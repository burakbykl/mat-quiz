...
function lastmessage() {
    ...
    if (fScore.innerText >= 800) {
        let emoji = "&#128525";
        message.innerHTML = "Baran 14 yaşında arkadaşları ona Einstein diyor" + emoji;
    } else if (fScore.innerText >= 500) {
        let emoji = "&#128531";
        message.innerHTML = "Güzel Sonuç " + emoji;
    } else if (fScore.innerText >= 100) {
        let emoji = "&#128549";
        message.innerHTML = "Bir dahaki sefere başarılar " + emoji;
    } else {
        let emoji = "&#128577";
        message.innerHTML = "Kötü şans " + emoji;
    }
}
